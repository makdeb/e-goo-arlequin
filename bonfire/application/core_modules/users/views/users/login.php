...
<?php echo form_open('login'); ?>
	...
	<div class="small indent">
		...
		<label style="text-align: left;" for="remember_me" class="remember"><?php echo lang('us_remember_note'); ?></label>
	</div>
	<?php endif; ?>

	<div class="submits">
		<input type="submit" name="submit" id="submit" value="Войти" tabindex="5" />	
	</div>
