...
<?php echo form_open($this->uri->uri_string()); ?>
	...
	<div>
		<label class="required" for="email"><b><?php echo lang('bf_email'); ?></b></label>
	...
	<fieldset>
		...
		<div>
			...
			<?php echo country_select(isset($user) && !empty($user->country_iso) ? $user->country_iso : 'UA', 'UA'); ?>
		</div>
		<div>
			<label for="state_code"><?php echo lang('us_state'); ?></label>
			<?php echo state_select(isset($user) ? $user->state_code : '', 'KIE', isset($user) && !empty($user->country_iso) ? $user->country_iso : 'UA'); ?>
		</div>
		<div style="display: none">
