...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Eventscategories.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Eventscategories.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_eventscategories())
			{
				...
				Template::redirect(SITE_AREA .'/developer/eventscategories');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Eventscategories.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/eventscategories');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Eventscategories.Developer.Delete');
