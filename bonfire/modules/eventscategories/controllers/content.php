...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Eventscategories.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Eventscategories.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_eventscategories())
			{
				...
				Template::redirect(SITE_AREA .'/content/eventscategories');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Eventscategories.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/eventscategories');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Eventscategories.Content.Delete');
