...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Eventscategories.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Eventscategories.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_eventscategories())
			{
				...
				Template::redirect(SITE_AREA .'/settings/eventscategories');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Eventscategories.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/eventscategories');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Eventscategories.Settings.Delete');
