...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit eventscategories" /> or <?php echo anchor(SITE_AREA .'/settings/eventscategories', lang('eventscategories_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/settings/eventscategories/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('eventscategories_delete_confirm'); ?>')"><?php echo lang('eventscategories_delete_record'); ?></a>
