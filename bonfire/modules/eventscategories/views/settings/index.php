<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/settings/eventscategories/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/settings/eventscategories/edit/'. $record->id, lang('eventscategories_edit'), '') ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
