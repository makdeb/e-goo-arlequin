...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Сохранить изменения" /> или <?php echo anchor(SITE_AREA .'/content/eventscategories', lang('eventscategories_cancel')); ?>
	</div>
	<?php echo form_close(); ?>
	...
	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/eventscategories/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('eventscategories_delete_confirm'); ?>')"><?php echo lang('eventscategories_delete_record'); ?></a>
