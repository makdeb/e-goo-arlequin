...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Forecasts.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Forecasts.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_forecasts())
			{
				...
				Template::redirect(SITE_AREA .'/settings/forecasts');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Forecasts.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/forecasts');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Forecasts.Settings.Delete');
