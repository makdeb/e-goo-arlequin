...
//--------------------------------------------------------------------
    ...
    public function __construct() 
    {
        ...
        $this->auth->restrict('Forecasts.Content.View');
    ...
    */
    public function index() 
    {
		...
		if (($this->input->post('newsletter'))&&($this->auth->restrict('Mail.Content.Send'))) 
		{	
    ...
    */
    ...
    {
        $this->auth->restrict('Forecasts.Content.Create');
    ...
    */
    ...
    {            
        $this->auth->restrict('Forecasts.Content.Edit');
        ...
        if (empty($id))
        {
            ...
            redirect(SITE_AREA .'/content/forecasts');
        }
    ...
    */
    ...
    {	
        $this->auth->restrict('Forecasts.Content.Delete');
