...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Forecasts.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Forecasts.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_forecasts())
			{
				...
				Template::redirect(SITE_AREA .'/developer/forecasts');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Forecasts.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/forecasts');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Forecasts.Developer.Delete');
