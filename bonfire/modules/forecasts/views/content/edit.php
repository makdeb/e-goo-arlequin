...
<div>
        ...
        <input id="event_date" type="text" name="event_date" maxlength="20" value="<?php echo set_value('event_date', isset($forecasts['event_date']) ? date("d.m.Y H:i:s",strtotime($forecasts['event_date'])) : ''); ?>"  />
</div>
...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Сохранить изменения" /> или <?php echo anchor(SITE_AREA .'/content/forecasts', lang('forecasts_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/forecasts/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('forecasts_delete_confirm'); ?>')"><?php echo lang('forecasts_delete_record'); ?></a>
		
		<h3><?php echo lang('forecasts_delete_record'); ?></h3>
