...
<div id='upload'>
	<p><?php echo $error;?></p>
	<p><?php echo $img;?></p>
	<form id="upload" action="<?php echo site_url(SITE_AREA .'/content/news/edit/'. $id); ?>" class="constrained ajax-form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Править новость" /> or <?php echo anchor(SITE_AREA .'/content/news', lang('news_cancel')); ?>
	</div>
	<?php echo form_close(); ?>
