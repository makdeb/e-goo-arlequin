...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Prices.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Prices.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_prices())
			{
				...
				Template::redirect(SITE_AREA .'/settings/prices');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Prices.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/prices');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Prices.Settings.Delete');
