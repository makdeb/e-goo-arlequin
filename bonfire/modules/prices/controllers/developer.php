...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Prices.Developer.View');
	...
	*/
	public function index() 
	{
		...
		Template::set('toolbar_title', "Manage Prices");
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Prices.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_prices())
			{
				...
				Template::redirect(SITE_AREA .'/developer/prices');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Prices.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/prices');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Prices.Developer.Delete');
	...
	*/
	...
	{	
		...
		$this->form_validation->set_rules('prices_name','Tarif','required|max_length[45]');			
		$this->form_validation->set_rules('prices_uah','Hrivna','required|is_decimal|max_length[6,2]');			
		$this->form_validation->set_rules('prices_rur','Rubl','required|is_decimal|max_length[6,2]');			
		$this->form_validation->set_rules('prices_usd','Dollar','required|is_decimal|max_length[6,2]');
