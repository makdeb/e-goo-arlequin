...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Prices.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Prices.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_prices())
			{
				...
				Template::redirect(SITE_AREA .'/reports/prices');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Prices.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/prices');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Prices.Reports.Delete');
