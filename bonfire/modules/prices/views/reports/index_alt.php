<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/reports/prices/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/reports/prices/edit/'. $record->id, lang('prices_edit'), '') ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
