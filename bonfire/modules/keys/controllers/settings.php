...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Keys.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Keys.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_keys())
			{
				...
				Template::redirect(SITE_AREA .'/settings/keys');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Keys.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/keys');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Keys.Settings.Delete');
