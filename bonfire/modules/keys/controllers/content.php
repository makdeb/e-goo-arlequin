...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Keys.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Keys.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_keys())
			{
				...
				Template::redirect(SITE_AREA .'/content/keys');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Keys.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/keys');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Keys.Content.Delete');
