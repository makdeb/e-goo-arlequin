<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/developer/keys/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/developer/keys/edit/'. $record->id, lang('keys_edit'), '') ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
